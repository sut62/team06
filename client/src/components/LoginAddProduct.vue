  ...
  <v-app id="login"  :style="{ backgroundImage: 'url(' + require('@/assets/BGLOG.jpg') + ')' }">
    <v-content>
      <v-container
              fluid
              class="hbg"
              id="customer"  :style="{ backgroundImage: 'url(' + require('@/assets/laddproduct.png') + ')' }"
      >
    ...
    <v-snackbar  top v-model="snaktn" :timeout="10000">{{snactexttrue}}
      <v-btn text @click="snaktn = false" to="/addproduct">OK</v-btn>
    </v-snackbar>
      ...
      UserValidate() {
        ...
        http
                ...
                .then(response => {
                  ...
                  if(this.message == '{"addproduct":"true"}'){
                    this.snaktn = true;
                  ...
                  else if(this.message == '{"addproduct":"false"}'){
                    this.snaktr = true;
